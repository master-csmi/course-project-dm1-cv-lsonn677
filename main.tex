...
\subsection*{langage et librairies appris}
\begin{itemize}
    \item{C++}
    \item{Python}
    \item{Jax}
...
\begin{tabular}{r| p{0.5\textwidth} c}
    \cvevent{2025}{stage: corrélation de région d'interet basé sur les marqueurs fiduciaires}{}{Strasbourg \color{cvred}}{A l'été 2026, j'ai pu avoir la chance de travailler avec le laboration cemosis ainsi qu'un laboratoire italien afin de développer une méthode de recalage de région d'interet pour l'imagerie des organes sur puces.}{cemosis.png} \\
\end{tabular}
\vspace{3em}

\begin{tabular}{r| p{0.5\textwidth} c}
    \cvevent{2025}{projet modélisation par EDP du comportement de cellules dans un environnement d'organe sur puce}{}{Strasbourg \color{cvred}}{Dans le cadre d'un projet de semestre, j'ai été amené à étudier et modéliser le comportement de cellules entre elles.}{cemosis.png} \\
\end{tabular}
\vspace{3em}
...
{\small Sonntag Lucas \icon{\faAt}{cvgreen}{} \protect\url{lucas.sonntag@etu.unistra.fr} \icon{\faMapMarker}{cvgreen}{} Alsace \icon{\faPhone}{cvgreen}{} +33 6.12.15.69.72
}
\end{center}
\end{minipage}
