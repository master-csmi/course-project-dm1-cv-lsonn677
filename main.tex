...
\begin{itemize}
    ...
    \item \textbf{calcul scientifique et à haute performance:}MPI, openmp, kokkos, tiling, opencl, JAX, openturns, feel++
    ...
    \item \textbf{Visualisation:} Matplotlib, Plotly, Dash
